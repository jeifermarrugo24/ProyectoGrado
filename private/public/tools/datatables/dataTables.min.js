...
!(function (n) {
  ...
  var C,
            ...
            if ("table" != this.nodeName.toLowerCase())
              ...
              for (e = 0, R = o.length; e < R; e++) {
                ...
                if (
                  ...
                  var l = (void 0 !== t.bRetrieve ? t : a).bRetrieve,
                    s = (void 0 !== t.bDestroy ? t : a).bDestroy;
              ...
              var u,
                ...
                n =
                  ...
                  t.aLengthMenu &&
                    !t.iDisplayLength &&
                    (t.iDisplayLength = Array.isArray(t.aLengthMenu[0])
                      ? t.aLengthMenu[0][0]
                  ...
                  Y(c, "aoStateSaveParams", t.fnStateSaveParams),
                  Y(c, "aoStateLoadParams", t.fnStateLoadParams),
                  ...
                  Y(c, "aoPreDrawCallback", t.fnPreDrawCallback),
                  (c.rowIdFn = U(t.rowId)),
                  c),
                d =
                  (V.__browser ||
                ...
                f =
                  ...
                  r.addClass(d.table),
                  c.oFeatures.bPaginate || (t.iDisplayStart = 0),
              ...
              if (t.aoColumns) h = t.aoColumns;
                ...
                for (R = n[(e = 0)].length; e < R; e++) h.push(null);
              ...
              var F,
                ...
                N =
                  ...
                  c.oFeatures);
              if ((t.bStateSave && (N.bStateSave = !0), void 0 === t.aaSorting))
                for (var j = c.aaSorting, e = 0, R = j.length; e < R; e++)
                  j[e][1] = c.aoColumns[e].asSorting[0];
              Zt(c),
                Y(c, "aoDrawCallback", function () {
                  (c.bSorted || "ssp" === J(c) || N.bDeferRender) && Zt(c);
                });
              var n = r.children("caption"),
                n =
                  (c.caption &&
                    (n = 0 === n.length ? H("<caption/>").appendTo(r) : n).html(
                      c.caption
                    ),
                  n.length &&
                ...
                n =
                  ...
                  r.children("tfoot")),
                O =
                  (0 === n.length && (n = H("<tfoot/>").appendTo(r)),
                  (c.nTFoot = n[0]),
              ...
              H.extend(!0, O, t.oLanguage),
                O.sUrl
                  ? H.ajax({
                      ...
                      success: function (t) {
                        B(a.oLanguage, t),
                          H.extend(!0, O, t, c.oInit.oLanguage),
                          G(c, null, "i18n", [c], !0),
                          Mt(c);
                      },
                      error: function () {
                        $(c, 0, "i18n file loading error", 21), Mt(c);
                      },
                    })
    ...
    L = function (t) {
      ...
      var e;
      for (t = t.replace(N, ""); (t = (e = t).replace(/<script/i, "")) !== e; );
      return e;
    },
    u = function (t) {
    ...
    e._hungarianMap || Z(e),
      H.each(n, function (t) {
        void 0 === (r = e._hungarianMap[t]) ||
          (!a && void 0 !== n[r]) ||
          ("o" === r.charAt(0)
            ? (n[r] || (n[r] = {}), H.extend(!0, n[r], n[t]), B(e[r], n[r], a))
            : (n[r] = n[t]));
      });
  }
  V.util = {
    ...
    set: function (a) {
      ...
      return H.isPlainObject(a)
        ...
        : ((f = function (t, e, n) {
            ...
            n.match(p) ? t[n.replace(p, "")](e) : (t[n.replace(pt, "")] = e);
          }),
          function (t, e) {
            return f(t, e, a);
          });
        ...
        : ((f = function (t, e, n) {
            ...
            if ("" !== n)
              for (var i = gt(n), l = 0, s = i.length; l < s; l++) {
                if (((d = i[l].match(pt)), (a = i[l].match(p)), d)) {
                  if (
                    ((i[l] = i[l].replace(pt, "")),
                    "" !== i[l] && (t = t[i[l]]),
                    (r = []),
    ...
    if (e.oFeatures.bAutoWidth) {
      var n,
        ...
        f =
          ...
          H(r.cloneNode()).css("visibility", "hidden").removeAttr("id")),
  ...
  function ot(t) {
    ...
    if (e.length)
      for (var r = 0, o = e[0].length; r < o; r++)
        n[r].bVisible && "none" !== H(e[0][r].cell).css("display") && a++;
    return a;
  }
  function it(t, n) {
    var a = [];
  ...
  function st(t) {
    for (
      ...
      if (b && !o._render) {
        ...
        for (var y, D = t, x = c, S = D.aoData, w = 0; w < S.length; w++)
          S[w].nTr &&
            ((y = q(D, w, x, "display")),
            (S[w].displayData[x] = y),
            ht(S[w].anCells[x], y));
    ...
    if (null === c.nTr) {
      for (
        ...
        (!u &&
          ...
          i.fnCreatedCell &&
            i.fnCreatedCell.call(t.oInstance, o, q(t, e, l), d, e, l);
      }
  ...
  function wt(t, e) {
    ...
    if (o) {
      if (
        ...
        1 === (n = (n = H("tr", o)).length ? n : H("<tr/>").appendTo(o)).length
      )
          ...
          return (
            ...
            void Ft(
              ...
              function (t) {
                ...
                for (var o = 0, i = n.length; o < i; o++) D(e, n[o]);
      ...
      if (0 !== o.length)
        for (var d = r ? t.aoData.length : s, f = r ? 0 : i; f < d; f++) {
          for (
            ...
            var m = u[v],
              b = p.anCells[v];
            y(b, C.type.className[m.sType]), y(b, t.oClasses.tbody.cell);
          }
          G(t, "aoRowCallback", null, [g, p._aData, a, f, h]), n.push(g), a++;
        }
      else n[0] = Ct(t);
  ...
  function Ct(t) {
    ...
    return (
      ...
      H("<tr/>").append(
        H("<td />", { colSpan: ot(t), class: t.oClasses.empty.row }).html(n)
      )[0]
    );
  }
  function Lt(t, e, r) {
    ...
    H.each(e, function (t, e) {
      var n, a;
      null !== e &&
        ((n = (t = t.match(/^([a-z]+)([0-9]*)([A-Za-z]*)$/))[2] ? +t[2] : 0),
            ...
            H.isPlainObject(a)
              ? a.features
                ...
                : Object.keys(a).map(function (t) {
                    o.contents.push({ feature: t, opts: a[t] });
                  })
              : o.contents.push(a);
          }
        })(
          (function (t, e, n) {
            for (var a, r = 0; r < t.length; r++)
              if (
                (a = t[r]).rowNum === e &&
                (("full" === n && a.full) ||
                  (("start" === n || "end" === n) && (a.start || a.end)))
              )
                return a[n] || (a[n] = { contents: [] }), a;
            return ((a = { rowNum: e })[n] = { contents: [] }), t.push(a), a;
          })(o, n, a),
          a,
          e
        );
      ...
      o.sort(function (t, e) {
        var n = t.rowNum,
          a = e.rowNum;
        return n === a
          ? ((t = t.full && !e.full ? -1 : 1), "bottom" === r ? -1 * t : t)
          : a - n;
      }),
      "bottom" === r && o.reverse();
  ...
  function It(e) {
    ...
    n.oFeatures.bProcessing &&
      ...
      v ? a.prependTo(H("div.dt-scroll", n.nTableWrapper)) : a.insertBefore(t),
          ...
          for (
            b = (b = +r.getAttribute("colspan")) && 0 != b && 1 != b ? b : 1,
              ...
              n &&
                (s &&
                  ...
                  d
                    ? (null === g.sTitle ||
                      ...
                      !g.sTitle &&
                        s &&
                        ((g.sTitle = L(r.innerHTML)), (g.autoTitle = !0)))
                    : g.footer && (r.innerHTML = g.footer),
                  g.ariaTitle ||
                    (g.ariaTitle = H(r).attr("aria-label") || g.sTitle),
                  g.className) &&
                ...
                H("<span>").addClass("dt-column-order").appendTo(r),
              i = 0;
            i < b;
            i++
          ) {
          ...
          error: function (t, e) {
            -1 === G(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) &&
              ("parsererror" == e
                ...
                : 4 === t.readyState && $(n, 0, "Ajax error", 7)),
              w(n, !1);
          },
        });
      ...
      for (
        ...
        if (c[d] && !(l = c[d])._aFilterData) {
          for (o = [], a = 0, r = u.length; a < r; a++)
            u[a].bSearchable
              ? "string" !=
                  typeof (i = null === (i = q(s, d, a, "filter")) ? "" : i) &&
                i.toString &&
                (i = i.toString())
              : (i = ""),
              i.indexOf &&
                -1 !== i.indexOf("&") &&
                ((Et.innerHTML = i), (i = kt ? Et.textContent : Et.innerText)),
            ...
            ("ssp" == c && !u) ||
              ("ajax" == c
                ? Ft(i, {}, function (t) {
                    ...
                    (i.iInitDisplayStart = n), d(i), w(i, !1), Ht(i);
                  })
                : (Ht(i), w(i, !1)));
        }),
  ...
  function qt(e) {
    ...
    if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis)
      ...
      if (
        ...
        for (var h = null, p = e._iDisplayStart; p < e.aiDisplay.length; p++) {
          var g = e.aiDisplay[p],
            g = e.aoData[g].nTr;
          if (g) {
            h = g;
        ...
        if (h)
          for (
            var v = H(h)
                .children("th, td")
                .map(function (t) {
                  return { idx: at(e, t), width: H(this).outerWidth() };
                }),
              p = 0;
            p < v.length;
            p++
  ...
  function Jt(t, e, n) {
    ...
    if ("ssp" != J(t) && 0 !== c.length) {
      ...
      c.length && "desc" === c[0].dir && t.orderDescReverse && d.reverse(),
        u.sort(function (t, e) {
          for (
            var n,
              a,
    ...
    return (
      void 0 === e &&
        ((t.bSorted = !0), (t.sortDetails = c), G(t, null, "order", [t, c])),
      u
    );
  }
  function Zt(t) {
    ...
    if (l.bSort && l.bSortClasses) {
      for (e = 0, n = r.length; e < n; e++)
        (a = r[e].src),
          H(m(t.aoData, "anCells", a)).removeClass(o + (e < 2 ? e + 1 : 3));
      for (e = 0, n = i.length; e < n; e++)
        (a = i[e].src),
          H(m(t.aoData, "anCells", a)).addClass(o + (e < 2 ? e + 1 : 3));
    }
    t.aLastSort = i;
  }
  function Qt(n) {
  ...
  function Kt(n, t, e) {
    ...
    if (t && t.time) {
      ...
      if (0 < l && t.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
        ...
        -1 !== G(n, "aoStateLoadParams", "stateLoadParams", [n, t]).indexOf(!1)
      )
        n._bLoadingState = !1;
        ...
        if (
          ...
          void 0 !== t.search && H.extend(n.oPreviousSearch, t.search),
          t.columns)
        ) {
        ...
        (n._bLoadingState = !1), G(n, "aoStateLoaded", "stateLoaded", [n, t]);
      }
  ...
  function $(t, e, n, a) {
    if (
      ...
      if ((t && G(t, null, "dt-error", [t, a, n], !0), "alert" == e)) alert(n);
      else {
  ...
  function te(t, e, n) {
    ...
    for (r in e)
      Object.prototype.hasOwnProperty.call(e, r) &&
        ((a = e[r]),
        H.isPlainObject(a)
          ? (H.isPlainObject(t[r]) || (t[r] = {}), H.extend(!0, t[r], a))
  ...
  (X = function (t, e) {
    ...
    (X.register = e =
      function (t, e) {
        if (Array.isArray(t))
          for (var n = 0, a = t.length; n < a; n++) X.register(t[n], e);
        else
          for (var r = t.split("."), o = oe, i = 0, l = r.length; i < l; i++) {
            var s,
              u,
              c = (function (t, e) {
    ...
    t &&
      ...
      "ssp" == J(r)
        ...
        : (w(r, !0),
          ...
          Ft(r, {}, function (t) {
            mt(r);
            for (var e = Nt(r, t), n = 0, a = e.length; n < a; n++) D(r, e[n]);
            d(r, o), Ht(r), w(r, !1);
          }));
  }
  ...
  e("tables()", function (t) {
        ...
        : this.iterator(
            ...
            function (t) {
              var e = H(t.nTable),
                ...
                a = H(t.nTableWrapper);
              n.length ||
                ((n = H("<caption/>").html(r)), (t.captionNode = n[0]), o) ||
    ...
    e("draw()", function (e) {
      return this.iterator("table", function (t) {
        "page" === e
          ? S(t)
          : d(t, !1 === (e = "string" == typeof e ? "full-hold" !== e : e));
      });
    }),
    e("page()", function (e) {
      return void 0 === e
    ...
    e("ajax.url()", function (e) {
      ...
      return void 0 === e
        ? 0 === t.length
          ? void 0
          : ((t = t[0]), H.isPlainObject(t.ajax) ? t.ajax.url : t.ajax)
        : this.iterator("table", function (t) {
  ...
  function fe(t, e) {
    ...
    if (n.length && t.length) {
      ...
      if (a._details) {
        (a._detailsShow = e)
          ? (a._details.insertAfter(a.nTr), H(a.nTr).addClass("dt-hasChild"))
          : (a._details.detach(), H(a.nTr).removeClass("dt-hasChild")),
        ...
        var i = n[0],
          ...
          a = "destroy" + a,
          l = i.aoData;
        if ((r.off(e + " " + t + " " + a), m(l, "_details").length > 0)) {
          r.on(e, function (t, e) {
            if (i !== e) return;
            r.rows({ page: "current" })
              .eq(0)
  ...
  function he(t, e, n, a, r, o) {
    for (var i = [], l = 0, s = r.length; l < s; l++) i.push(q(t, r[l], e, o));
    return i;
  }
  function pe(t, e, n) {
    var a = t.aoHeader;
  ...
  function ge(e, n) {
    return function (t) {
      return (
        T(t) ||
          "string" != typeof t ||
          ((t = t.replace(F, " ")), e && (t = L(t)), n && (t = k(t, !1))),
        t
      );
    };
  }
            ...
            this.iterator("table", function (t) {
              _t(t, t.aoHeader),
                ...
                e.iterator("column", function (t, e) {
                  r.includes(e) &&
                    G(t, null, "column-visibility", [t, e, n, a]);
                }),
  ...
  var l = V.ext.type,
    Ne =
      ...
      V.type("html", {
        detect: {
          allOf: function (t) {
            return T(t) || ("string" == typeof t && -1 !== t.indexOf("<"));
          },
          oneOf: function (t) {
            return !T(t) && "string" == typeof t && -1 !== t.indexOf("<");
          },
        ...
        order: {
          pre: function (t) {
            return T(t) ? "" : t.replace ? L(t).trim().toLowerCase() : t + "";
          },
        },
        search: ge(!0, !0),
      }),
        ...
        detect: {
          allOf: function (t) {
            ...
            return !t || t instanceof Date || R.test(t)
              ? (null !== (e = Date.parse(t)) && !isNaN(e)) || T(t)
              : null;
          },
          oneOf: function (t) {
            return t instanceof Date || ("string" == typeof t && R.test(t));
          },
        },
        order: {
          pre: function (t) {
  ...
  H.extend(!0, V.ext.renderer, {
                ...
                if (n) {
                    ...
                    var a = v.order,
                      ...
                      d =
                        (g
                          ...
                          .toggleClass(a.canAsc, i && u.includes("asc"))
                          .toggleClass(a.canDesc, i && u.includes("desc")),
                        !0),
                      f = 0;
                    f < s.length;
                    f++
                  ...
                  s[0] == h
                    ? ((r = n[0]),
                      ...
                      (l = u[r.index + 1] ? "Reverse" : "Remove"))
                    : g.removeAttr("aria-sort"),
                    g.attr(
                      "aria-label",
                      i
                        ? o.ariaTitle + e.api.i18n("oAria.orderable" + l)
                        : o.ariaTitle
                    ),
                    i &&
                      (g.find(".dt-column-title").attr("role", "button"),
                      g.attr("tabindex", 0));
                }
              }
            }
      ...
      _: function (t, e, n) {
        ...
        H.each(n, function (t, e) {
          ...
          "id" !== t &&
            "className" !== t &&
            ((n = ""),
            e.table && (r.addClass(a.tableRow), (n += a.tableCell + " ")),
            (n += "start" === t ? a.start : "end" === t ? a.end : a.full),
            H("<div/>")
              .attr({
                id: e.id || null,
    ...
    (V.feature.register = function (t, e, n) {
      (V.ext.features[t] = e), n && C.feature.push({ cFeature: n, fnInit: e });
    }),
  ...
  V.feature.register(
            ...
            (r.return && "Enter" !== t.key) ||
              (e != r.search &&
                Vt(n, a.processing, function () {
                  (r.search = e), Rt(n, r), (n._iDisplayStart = 0), S(n);
                }));
          }),
    ...
    V.feature.register(
      ...
      function (t, e) {
        ...
        function n() {
          !(function t(e, n, a) {
            ...
            for (var p = 0; p < f.length; p++) {
              ...
              H(m.clicker).attr({
                ...
                ee(m.clicker, { action: g }, function (t) {
                  t.preventDefault(), Xt(e, t.data.action, !0);
                }),
                h.push(m.display);
            }
            ...
            h.length &&
              ...
              t(e, n, H.extend({}, a, { buttons: a.buttons - 2 }));
          })(t, a.children(), e);
        }
        var a = H("<div/>")
          .addClass(
            t.oClasses.paging.container + (e.type ? " paging_" + e.type : "")
          )
          .append(
            H("<nav>")
        ...
        return (
          t.aoDrawCallback.push(n), H(t.nTable).on("column-sizing.dt.DT", n), a
        );
      },
      "p"
    );
  ...
  return (
    V.feature.register(
      ...
      function (a, t) {
        ...
        t = H.extend({ menu: a.aLengthMenu, text: a.oLanguage.sLengthMenu }, t);
        ...
        for (
          var l = t.text.match(/_MENU_$/),
            ...
            c = H("<div/>")
              ...
              .append(t.replace("_MENU_", '<span id="' + s + '"></span>')),
            d = [],
            f =
              (Array.from(c.find("label")[0].childNodes).forEach(function (t) {
